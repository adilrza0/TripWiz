  ...
  return (
    <div>
      <div className="main-container">
        ...
        <h1>
          Enjoy The Best Moments <br /> With TripWiz
        </h1>

        <p>
          We have more than one million happy customers around the world and{" "}
          <br /> More than 70 plus destination around the globe
        </p>
        ...
        <div className="main-homecard">
          ...
          <div className="homecard">
            ...
            <div className="searchButton">
              <Link to={activeButton==="hotels"?"/hotels":"flight"}>
              <button  >Search {activeButton}</button>
              </Link>
            </div>
          </div>
        </div>
      ...
      <div className="destination">
        ...
        <span className="span3">
          From historical cities to natural slendours,come see the best of the
          world.
        </span>
      ...
      <div className="nights3">
        <div className="main-night3">
          <div className="first-night3">
            <p>
              {" "}
              <CiLocationOn /> Suthern Angean Sea, Santorini, Greece
            </p>
            <h1>3 Nights Oasis Hotel</h1>
            <p>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Rerum
              iure qui voluptas dolorum non quibusdam consectetur esse? Ipsam,
        ...
        <div className="dest-pics2">
          <div className="card-1">
            <div className="card-2">
              ...
              <span>
                {" "}
                I wanted to share with you the incredible journey I recently
                embarked upon to witness the awe-inspiring{" "}
              </span>
          ...
          <div className="card-12">
            <div className="card-2">
              ...
              <span>
                {" "}
                I recently embarked upon to witness the awe-inspiring I wanted
                to share with you the incredible journey{" "}
              </span>
              <button className="read-more">Read More</button>
            </div>
          </div>
      ...
      <div className="customer">
        <div className="customer-main">
          <div className="card">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/Zoellick%2C_Robert_%28official_portrait_2008%29.jpg/330px-Zoellick%2C_Robert_%28official_portrait_2008%29.jpg"
              alt=""
            />
            ...
            <p>
              ...
              reprehenderit laudantium porro molestiae iure! Id, dolorem
              possimus ex aliquam voluptates officiis eos perferendis nesciunt
              enim aut natus esse, praesentium libero.
            </p>
          </div>
          <div className="card">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Tom_Cruise_by_Gage_Skidmore_2.jpg/330px-Tom_Cruise_by_Gage_Skidmore_2.jpg"
              alt=""
            />
          ...
          <div className="card">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c4/Nicole_Kidman_2_%2829900987478%29.jpg/330px-Nicole_Kidman_2_%2829900987478%29.jpg"
              alt=""
            />
          ...
          <div className="card">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/Sebastian_Stan_by_Gage_Skidmore_2_%28cropped%29.jpg/330px-Sebastian_Stan_by_Gage_Skidmore_2_%28cropped%29.jpg"
              alt=""
            />
        ...
        <div className="subscribe">
          ...
          <p>
            We will keep your information secret & will send you the offer
            updates.
          </p>
